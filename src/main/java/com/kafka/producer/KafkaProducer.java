...
public class KafkaProducer extends Thread {
    ...
    private final Producer<Integer, Object> producer;
    ...
    public KafkaProducer(String topic) {
        ...
        producer = new Producer<Integer, Object>(new ProducerConfig(props)); // 设置producer的配置
    ...
    public void run() {
        ...
        while (true) {
            ...
            producer.send(new KeyedMessage<Integer, Object>(topic, message));
            messageNo++;
            try {
                sleep(1000); // 一秒发送一次消息
